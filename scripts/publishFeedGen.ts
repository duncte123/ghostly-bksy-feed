...
const run = async () => {
  ...
  const description =
    'Posts about video game speedrunning events, personalities, and culture. For guaranteed inclusion, use #speedrun. FAQ: https://github.com/goth-uhaul/hjb-speedfeed/blob/main/faq.md. Maintained by @jayena.hijumpboots.com'
